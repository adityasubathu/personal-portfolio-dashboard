...
from app.routers import trades, portfolio, kite, mf, mf_breakdown, manual_assets, settings as settings_router, charts, policy_tracker, usdinr, demo, market_sentiment, capital_gains  # noqa: E402
