...
- Capital Gains: the per-bucket tax estimate cards now centre themselves, so a short row sits in the middle instead of hugging the left edge. (2026-09-20-15-51-23 · PENDING)
